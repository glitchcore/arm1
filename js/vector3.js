 ...
 * @constructor
 */
armgpu.Vector3 = function(opt_x, opt_y, opt_z) {
  /**
 ...
 */
armgpu.Vector3.prototype.magnitude = function() {
 ...
 * @return {number} the magnitude of the vector.
 */
armgpu.Vector3.prototype.normalize = function() {
  var mag = this.magnitude();
  if (mag < armgpu.Vector3.DOUBLE_EPSILON)
 ...
 */
armgpu.Vector3.prototype.scale = function(s) {
  this.x *= s;
  this.y *= s;
  this.z *= s;
}
 ...
 * @param {!armgpu.Vector3} v The vector to dot.
 * @return {number} the result of |this| . v.
 */
armgpu.Vector3.prototype.dot = function(v) {
  return this.x * v.x + this.y * v.y + this.z * v.z;
}

/**
 * Compute the cross product: |this| X v.
 * @param {!armgpu.Vector3} v The vector to cross with.
 * @return {armgpu.Vector3} the result of |this| X v.
 */
armgpu.Vector3.prototype.cross = function(v) {
  var vCross = new armgpu.Vector3(this.y * v.z - this.z * v.y,
 ...
 * @type {number}
 */
armgpu.Vector3.DOUBLE_EPSILON = 1.0e-16;
